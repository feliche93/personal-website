...
export default function Calendar() {
  ...
  useEffect(() => {
    (async function () {
      ...
      cal("ui", { "theme": "light", "styles": { "branding": { "brandColor": "#2563EB" } } });
    })();
  }, []);
  ...
  return (
    <div className="relative pt-16 sm:pt-24 lg:pt-32">
      ...
      <Cal allowtransparency="true" calLink="felix-vemmer/30-minute-google-hangout-chat" className='pt-10 w-auto overflow-hidden' />
